...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $stmt=$conn->prepare("INSERT INTO job_tasks (job_id,task) VALUES (?,?)");
...
<title>Add Task — Garage System</title>
...
<div class="form-card">
    <form method="POST">
        ...
        <div class="field-group">
            ...
            <input class="field-input" name="task" placeholder="e.g. Replace front brake pads" required>
        </div>
